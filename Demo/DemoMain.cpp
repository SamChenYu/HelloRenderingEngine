    ...
    try
    {
        ...
        agl::polygon<GLfloat, 6, agl::dimensionality{2}, agl::texture_coordinates<GLfloat>> hex{
            ...
            agl::texture_2d_configurator{
                ...
                .parameter_setter{ [](){ agl::gl_function{&GladGLContext::TexParameteri}(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR); }},
                .label{"Princess TS"}
            },
            make_label("Hexagon")
        };
        ...
        while(!glfwWindowShouldClose(&w.get())) {
            agl::gl_function{&GladGLContext::ClearColor}(0.2f, 0.3f, 0.3f, 1.0f);
            agl::gl_function{&GladGLContext::Clear}(GL_COLOR_BUFFER_BIT);
