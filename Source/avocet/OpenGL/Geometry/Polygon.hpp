...
namespace avocet::opengl {
    ...
    private:
        ...
        static void do_draw() {
            gl_function{&GladGLContext::DrawElements}(GL_TRIANGLES, num_elements, to_gl_enum(to_gl_type_specifier_v<element_index_type>), nullptr);
        }
    ...
    private:
        ...
        static void do_draw() {
            gl_function{&GladGLContext::DrawArrays}(GL_TRIANGLES, 0, 3);
        }
    };
