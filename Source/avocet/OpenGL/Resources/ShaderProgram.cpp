    ...
    namespace {
        ...
        private:
            ...
            GLint get_parameter_value(GLenum paramName) const {
                GLint param{};
                m_ParamGetter(m_Ctx, get_index(m_Handle), paramName, &param);
                return param;
            }
            ...
            std::string get_info_log() const {
                ...
                m_InfoLogGetter(m_Ctx, get_index(m_Handle), logLen, nullptr, info.data());
                return info;
            }
        };
        ...
        public:
            ...
            {
                gl_function{&GladGLContext::AttachShader}(m_Ctx, m_ProgIndex, m_ShaderIndex);
            }

            ~shader_attacher() { gl_function{&GladGLContext::DetachShader}(m_Ctx, m_ProgIndex, m_ShaderIndex); }
        };
